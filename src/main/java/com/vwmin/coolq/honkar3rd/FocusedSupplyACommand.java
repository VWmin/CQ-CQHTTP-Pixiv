 ...
 */
@CommandController(bind = "!精准十连a")
public class FocusedSupplyACommand implements Reply {
    private final
    GachaOperator operator;

    public FocusedSupplyACommand(GachaOperator operator) {
    ...
    public ReplyEntity call(PostEntity postEntity) {
        ...
        Pair<GachaType, List<Item>> pair = operator.focusedA10(person);
