...
public class PixivArgsDispatcher implements ArgsDispatcher {
    ...
    @Override
    public MessageSender setPostMessage(BaseSession session) {
        ...
        private void onSuccess(){
            ...
            if(type.equals("rank")){
                ...
                try {
                    ...
                    IllustsResponseConsumer comsumer = new IllustsResponseConsumer(illustsResponse, postMessage.getUser_id());
                    send = cqClientService.creatMessageEntity(postMessage.getMessage_type(), ((HasId) postMessage).getId(), comsumer.top10("none", isShowDetail));
